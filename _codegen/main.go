...
var (
	pkg       = flag.String("assert-path", "github.com/Way-wzc/testify/assert", "Path to the assert package")
...
var headerTemplate = `/*
* CODE GENERATED AUTOMATICALLY WITH github.com/Way-wzc/testify/_codegen
